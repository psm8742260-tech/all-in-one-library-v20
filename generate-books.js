...
const exportIndex = existingData.indexOf('export const INITIAL_BOOKS: Book[] = [');

let existingBooksArrayStr = existingData.substring(exportIndex + 'export const INITIAL_BOOKS: Book[] = ['.length);
// Just finding a way to append. Actually, let's just replace the entire file with parsed existing or a clean rewrite.
